...
-}
webBackForwardListAddItem :: WebBackForwardList -- ^ the 'WebBackForwardList'
...
webBackForwardListContainsItem :: WebBackForwardList -- ^ a 'WebBackForwardList'
                               -> WebHistoryItem     -- ^ a 'WebHistoryItem'
                               -> IO Bool            -- ^ 'True' if
                                                     --   'WebHistoryItem' is in
                                                     --   'WebBackForwardList',
                                                     --   otherwise 'False'
...
webBackForwardListGetBackItem :: WebBackForwardList -- ^ a 'WebBackForwardList'
                              -> IO WebHistoryItem  -- ^ the 'WebHistoryItem'
...
webBackForwardListGetBackLength :: WebBackForwardList -- ^ 'WebBackForwardList'
                                -> IO Int             -- ^ the number of items
                                                      --   preceding the current
                                                      --   item 
...
{- | Returns a list of items that precede the current item, limited by a given
     limit.
-}
webBackForwardListGetBackListWithLimit :: WebBackForwardList  -- ^ the list
                                       -> Int                 -- ^ the limit
                                       -> IO [WebHistoryItem] -- ^ the preceding
                                                              --   items
...
webBackForwardListGetCurrentItem :: WebBackForwardList        -- ^ the list
                                 -> IO (Maybe WebHistoryItem) -- ^ 'Nothing' if
                                                              --   the list is
                                                              --   empty, 'Just'
                                                              --   the item
                                                              --   otherwise
...
webBackForwardListGetForwardItem :: WebBackForwardList         -- ^ the list
                                 -> IO (Maybe WebHistoryItem)  -- ^ 'Nothing' if
                                                               --   there is no
                                                               --   next item,
                                                               --   'Just' the
...
webBackForwardListGetForwardLength :: WebBackForwardList -- ^ the list
                                   -> IO Int             -- ^ number of items
                                                         --   that succeed the
                                                         --   current item
...
{- | Returns a list of items that succeed the current item, limited by a given
     limit.
-}
webBackForwardListGetForwardListWithLimit :: WebBackForwardList  -- ^ the list
                                          -> Int                 -- ^ the limit
                                          -> IO [WebHistoryItem] -- ^ succeeding
                                                                 --   items
...
webBackForwardListGetLimit :: WebBackForwardList -- ^ a 'WebBackForwardList'
                           -> IO Int             -- ^ the number of
                                                 --   'WebHistoryItem's the
                                                 --   'WebBackForwardList'
                                                 --   can hold
...
webBackForwardListGetNthItem :: WebBackForwardList        -- ^ the list
                             -> Int                       -- ^ index of the item
                             -> IO (Maybe WebHistoryItem) -- ^ 'Just' the
                                                          --   corresponding
                                                          --   item if existing,
                                                          --   'Nothing'
                                                          --   otherwise
...
webBackForwardListGoBack :: WebBackForwardList -- ^ the 'WebBackForwardList'
                         -> IO ()
...
webBackForwardListGoForward :: WebBackForwardList -- ^ the 'WebBackForwardList'
                            -> IO ()
...
webBackForwardListGoToItem :: WebBackForwardList -- ^ the 'WebBackForwardList'
...
{- | Creates an instance of the 'WebBackForwardList' with a controlling
     'WebView'.
-}
webBackForwardListNewWithWebView :: WebView               -- ^ a 'WebView'
...
-}
webBackForwardListSetLimit :: WebBackForwardList -- ^ a 'WebBackForwardList'
                           -> Int                -- ^ the new limit
                           -> IO ()
