...
-}
downloadCancel :: Download -- ^ the 'Download' to be canceled
               -> IO ()
...
downloadGetCurrentSize :: Download   -- ^ 'Download' to determine size of
...
{- | Obtains the URI to which the downloaded file will be written. This must 
     ...
     and may be 'Nothing'.
-}
downloadGetDestinationUri :: Download          -- ^ 'Download' to get the URI of
                          -> IO (Maybe String) -- ^ 'Just' the URI or 'Nothing'
                                               --   if unset
...
-}
downloadGetElapsedTime :: Download  -- ^ the 'Download' to examine
...
downloadGetNetworkRequest :: Download          -- ^ the 'Download'
                          -> IO NetworkRequest -- ^ the corresponding
                                               --   'NetworkRequest'
...
downloadGetNetworkResponse :: Download           -- ^ the 'Download'
                           -> IO NetworkResponse -- ^ the corresponding
                                                 --   'NetworkResponse'
...
-}
downloadGetProgress :: Download  -- ^ the 'Download'
...
downloadGetStatus :: Download          -- ^ the 'Download'
...
-}
downloadGetSuggestedFileName :: Download  -- ^ the 'Download'
...
-}
downloadGetTotalSize :: Download   -- ^ the 'Download'
...
-}
downloadGetUri :: Download  -- ^ the 'Download'
...
downloadNew :: NetworkRequest -- ^ the 'NetworkRequest'
...
downloadSetDestinationUri :: Download -- ^ the 'Download'
...
-}
downloadStart :: Download -- ^ the 'Download' to start
              -> IO ()
